...
public:
    ...
    //根据地址获取本地设备参数
    static void getDevicePara(QString &mediaUrl, QString &bufferSize, int &frameRate, QString &codecName, int &offsetX, int &offsetY, QString &encodeScale);
    //根据地址获取通用地址参数
    ...
    static void initVideoPara(VideoThread *videoThread, const QString &mediaUrl, QString &encodeVideoScale);
};
