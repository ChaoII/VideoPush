...
public:
    ...
    //获取推流完整地址
    static QString
    getPushUrl(const QString &pushType, const QString &pushMode, const QString &pushUrl, const QString &pushHost);
    ...
    static QString
    getPullUrl(const QString &pushUrl, const QString &pushType, const QString &pullType, const QString &host,
               const QString &flag);

    //根据流媒体服务器类型获取不同的四种拉流类型
    static void
    getPullUrl(const QString &pushUrl, const QString &pushType, const QString &host, const QString &flag, QString &url1,
               QString &url2, QString &url3, QString &url4);
    ...
    static void
    preview(const QString &httpUrl, const QString &fileName, quint8 number, const QStringList &urls, bool liveplayer);
