...
public:
    ...
    //插入文件推流信息到表格
    static void addFile(QTableWidget *tableWidget, const QString &file, FilePushServer *pushServer,
                        const QString &flag = QString());

    //更新文件唯一标识到表格
    static void
    updateFile(QTableWidget *tableWidget, int row, const QString &srcFlag, const QString &dstFlag, const QString &file,
               FilePushServer *pushServer);
    ...
    //插入网络推流地址到表格
    static void
    addUrl(QTableWidget *tableWidget, const QString &url, NetPushServer *pushServer, const QString &flag = QString());

    //更新网络唯一标识到表格
    static void
    updateUrl(QTableWidget *tableWidget, int row, const QString &srcFlag, const QString &dstFlag, const QString &url,
