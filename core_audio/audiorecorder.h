...
public slots:
    ...
    //初始化参数
    void
    initPara(const QString &deviceName, int sampleRate, int bitRate, int channelCount, int quality, int encodingMode);
...
signals:
    ...
    //打印数据消息
    void receiveData(int sampleRate, int sampleSize, int64_t byteCount);
