...
void FFmpegHelper::initLib()
{
    ...
    if (!isInit) {
        ...
        //FFmpegUtil::debugHardware();
        //FFmpegUtil::showDevice();
        //FFmpegUtil::showDeviceOption("video=/dev/video0");
        //FFmpegUtil::showDeviceOption("video=Webcam");
        //FFmpegUtil::showDeviceOption("audio=麦克风 (USB Audio Device)");        
    }
}
