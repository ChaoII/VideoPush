...
public:
    explicit frmNetPush(QWidget *parent = nullptr);
...
private:
    ...
    QString fileNameUrl;
    //网络推流服务对象
    NetPushServer *pushServer = nullptr;
    ...
    int rotate_ = 0;
    //当前选中推流对应视频解码线程
    FFmpegThread *videoThread = nullptr;

    //实时视频预览窗体
    ImageLabel *labImage = nullptr;
    YuvWidget *yuvWidget = nullptr;
